...
Node coordinates are normalized either to a unit square or to the pixel space of a background image, with both the source image and a render-ready copy stored in the object. This establishes a stable reference frame for registering graphs to external images and maps.
