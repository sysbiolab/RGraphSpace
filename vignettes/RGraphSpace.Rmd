---
title: "*RGraphSpace*: A lightweight interface for representing *igraph* objects in a normalized coordinate system." 
author: "Sysbiolab - Bioinformatics and Systems Biology Laboratory"
date: "`r Sys.Date()`"
bibliography: bibliography.bib
abstract: "*RGraphSpace* is an *R* package that integrates *igraph* and *ggplot2* graphics within spatial maps. *RGraphSpace* implements new geometric objects using *ggplot2* prototypes, customized for scaling graph elements in a normalized coordinate system."
output: 
  html_document:
    theme: cerulean
    self_contained: yes
