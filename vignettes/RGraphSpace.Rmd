...
abstract: "<p>*RGraphSpace* is an R package that integrates *igraph* and *ggplot2* graphics within spatial maps. *RGraphSpace* implements new geometric objects using *ggplot2* protypes, customized for representing large *igraph* objects in a normalized coordinate system.</p>"
...
output: 
  BiocStyle::html_document:
    ...
    css: custom.css
vignette: >
  %\VignetteIndexEntry{"RGraphSpace: ggplot2 graphics for PathwaySpace."}
...
```{r A shortcut for RGraphSpace, eval=TRUE, message=FALSE, out.width="60%"}
...
## currently in Bioc devel (version >= 3.19)
## https://bioconductor.org/packages/devel/bioc/html/RedeR.html
library(RedeR) 
startRedeR()
resetRedeR()
...
* Sysbiolab Team. "RGraphSpace: A lightweight package for representing large igraph objects in a normalized coordinate system." R package, 2023.
