...
The following example demonstrates interoperability between *RGraphSpace* and *RedeR* [@Castro2012], an R/Bioconductor package for interactive network visualization and manipulation.
...
```{r Plot gtoy1, eval=TRUE, message=FALSE}
library("RGraphSpace")
library("RedeR")
library("igraph")
...
```{r Plot large igraph - 1, eval=TRUE, message=FALSE}
...
```{r Plot large igraph - 2, eval=FALSE, message=FALSE}
# Launch the RedeR application
startRedeR()
resetRedeR()
...
# p <- plotGraphSpace(gtoy2_2, node.labels = FALSE)
