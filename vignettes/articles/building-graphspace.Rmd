...
Alternatively, an `igraph` can be converted to a `GraphSpace` object and passed directly to *ggplot2* geoms.
...
The resulting `GraphSpace` integrates with *ggplot2*, allowing graph-specific geoms to be combined with standard *ggplot2* layers.
