...
*RGraphSpace* implements two specialized `geoms` for handling graph data within a *ggplot2* workflow. Both use a dual-anchor normalization strategy to keep layers aligned, which is essential when network elements must remain accurately referenced to a spatial map or image.
