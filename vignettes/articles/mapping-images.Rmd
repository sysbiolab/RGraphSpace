...
```{r Mapping images - 1, eval=TRUE, message=FALSE, out.width="100%"}
library("RGraphSpace")
library("igraph")
library("ggplot2")
...
```{r Mapping images - 2, eval=TRUE, message=FALSE, out.width="100%"}
...
```{r Mapping images - 3, eval=TRUE, message=FALSE, out.width="100%"}
...
```{r Mapping images - 4, eval=TRUE, message=FALSE, out.width="100%"}
