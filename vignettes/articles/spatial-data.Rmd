...
This vignette demonstrates how *RGraphSpace* extends the *ggplot2* grammar
to spatial transcriptomics data. We use spatial data from the
*SeuratData* package to show how spatial variables can be mapped directly
...
```{r ggplot_seurat3.png, eval=FALSE, message=FALSE, echo=FALSE, include=FALSE, purl=FALSE}
# p <- ggplot(gs) +
#   annotation_gspace(gs) +
...
#   theme_gspace_coords(theme = "th3", is_norm = TRUE,
#     xlab = "Tissue coordinates 1", ylab = "Tissue coordinates 2")
# ggsave(filename = "./vignettes/articles/figs_dev/ggplot_seurat3.png",
#   height=5, width=6, units="in", device="png", dpi=200, plot=p)
```

```{r ggplot_seurat3, echo=FALSE, out.width = '100%', purl=FALSE}
knitr::include_graphics("figs_dev/ggplot_seurat3.png")
```
...
```{r ggplot_seurat4.png, eval=FALSE, message=FALSE, echo=FALSE, include=FALSE, purl=FALSE}
p <- ggplot(gs) +
  annotation_gspace(gs, opacity = 0.5) +
  geom_nodespace(mapping = aes(fill = seurat_clusters),
    size = 1.3, color = "grey90", stroke = 0.3) +
  ...
  theme_gspace_coords(theme = "th2", is_norm = TRUE,
    xlab = "Tissue coordinates 1", ylab = "Tissue coordinates 2") +
  theme_gspace_legend(discrete_fill = TRUE)
ggsave(filename = "./vignettes/articles/figs_dev/ggplot_seurat4.png",
  height=5, width=6, units="in", device="png", dpi=200, plot=p)
```

```{r ggplot_seurat4, echo=FALSE, out.width = '100%', purl=FALSE}
knitr::include_graphics("figs_dev/ggplot_seurat4.png")
```
