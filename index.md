...
Core functionality relies only on lightweight R packages; optional geometry and large raster-image features use the *sf* and *terra* packages (and their system libraries) when installed.
