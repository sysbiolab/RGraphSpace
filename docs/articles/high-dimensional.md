...
## Session information
    ...
    #>  [40] irlba_2.3.7            textshaping_1.0.5      progressr_0.19.0      
    #>  [43] spatstat.sparse_3.2-0  httr_1.4.8             polyclip_1.10-7       
    #>  [46] abind_1.4-8            compiler_4.6.0         withr_3.0.2           
    #>  [49] S7_0.2.2               fastDummies_1.7.6      MASS_7.3-65           
    #>  [52] rappdirs_0.3.4         tools_4.6.0            vipor_0.4.7           
    ...
    #>  [70] spatstat.data_3.1-9    tidyr_1.3.2            data.table_1.18.4     
    #>  [73] tidygraph_1.3.1        spatstat.geom_3.8-1    RcppAnnoy_0.0.23      
    ...
    #>  [94] xfun_0.58              matrixStats_1.5.0      stringi_1.8.7         
