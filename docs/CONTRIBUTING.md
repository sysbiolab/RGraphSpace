...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("sysbiolab/RGraphSpace", fork = TRUE)`.
...
Please note that the RGraphSpace project is released with a [Contributor
Code of
Conduct](https://sysbiolab.github.io/RGraphSpace/CODE_OF_CONDUCT.md). By
